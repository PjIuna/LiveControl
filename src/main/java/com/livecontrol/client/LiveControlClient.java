...
public final class LiveControlClient implements ClientModInitializer {
    ...
    private static Vec3d previousPlayerPos = null;
    ...
    private static Vec3d safeZoneEscapeTargetCenter = null;
    private static double safeZoneEscapeTargetClearRadius = 0.0D;
